          ...
          <Flex alignItems="center" placeSelf={"center"}>
            <NextLink href={"https://www.facebook.com/KattensVaern"} passHref>
              <Link isExternal justifyContent={"center"} alignItems="center">
                <Icon display={"flex"} justifyContent={"center"} alignItems="center" color="brand.darkGrey" w={9} h={9} as={AiOutlineFacebook} />
              </Link>
            </NextLink>
            <NextLink href={"https://www.instagram.com/kattensvaern/"} passHref>
              <Link isExternal display={"flex"} justifyContent={"center"} alignItems="center" mr="4px">
                <Icon display={"flex"} justifyContent={"center"} alignItems="center" color="brand.darkGrey" w={10} h={10} as={AiOutlineInstagram} />
              </Link>
            </NextLink>
            <NextLink href={"https://www.tiktok.com/@kattensvaern"} passHref>
              <Link isExternal borderRadius={"0.2rem"} border={"2px solid black"} px="0.2rem" py="0.2rem" mr="4px">
                <Icon display={"flex"} justifyContent={"center"} alignItems="center" color="brand.darkGrey" w={5} h={5} as={FaTiktok} />
              </Link>
            </NextLink>
            <NextLink href={"https://www.youtube.com/KattensVaern"} passHref>
              <Link isExternal display={"flex"} justifyContent={"center"} alignItems="center">
                <Icon display={"flex"} justifyContent={"center"} alignItems="center" color="brand.darkGrey" w={10} h={10} as={AiOutlineYoutube} />
              </Link>
            </NextLink>
          </Flex>
        </Box>
