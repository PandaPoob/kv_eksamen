  ...
  return (
    <Box display={"grid"} gridTemplateColumns={{ lg: "1fr 1fr" }} gap={{ base: "2rem", lg: "4rem" }} maxW="container.xl" m="auto" pb="6rem">
      <Box bg="brand.lightGrey" p="2rem" display={"grid"} gap="2rem" borderRadius={"0.3rem"}>
        ...
        <Text>
          Når man adopterer en kat, får man udleveret en blanket med en kode på, som man selv skal registrere, når man kommer hjem. Efterfølgende tilsender Royal Canin 2 kg kattemad af den variant, som ens kat skal have,
          som gave, direkte hjem til din adresse.
        </Text>
      ...
      <Box bg="brand.lightGrey" p="2rem" borderRadius={"0.3rem"}>
        ...
        <List display={"grid"} gap="1.5rem">
          <ListItem display={"flex"} alignItems="center">
            ...
            <Text>At ingen af vores katte kan reserveres via mail eller pr. telefon, så hvis du falder for kat på vores hjemmeside, så kom ind og mød den på internatet i formidlingstiden eller efter aftale.</Text>
          </ListItem>
          <ListItem display={"flex"} alignItems="center">
            <ListIcon as={ImDiamonds} color="brand.redCta"></ListIcon>
            <Text>At ingen af vores katte kan forlade bygningen, uden at være i en transportkasse. Hvis du ikke selv har en med, kan der købes en på internatet.</Text>
          </ListItem>
          <ListItem display={"flex"} alignItems="center">
            <ListIcon as={ImDiamonds} color="brand.redCta"></ListIcon>
            <Text>
              Du kan købe alt nødvendigt tilbehør på vores internater eller på vores webshop som har udvalgte varer{" "}
