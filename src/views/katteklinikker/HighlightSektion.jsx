...
export default function HighlightSektion({acf}) {
  ...
  return (
    <Box position="relative" display={"grid"} gridTemplateColumns="1fr 1fr" gridTemplateRows="repeat(3, 1fr)" height={"60vh"} width={"100vw"} overflow="hidden" backgroundImage={a.baggrundsbillede} bgPosition={"center"} bgSize="cover">
