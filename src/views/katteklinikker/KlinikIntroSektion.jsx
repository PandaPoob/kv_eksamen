...
export default function KlinikIntroSektion({acf}) {
  return (
    <Box as="section" display={"grid"} placeContent="center"  my={{base: "3rem", lg: "6rem"}} mx="1rem">
        <Box maxW={"container.xl"} display={"grid"} gridTemplateColumns={{base: "1fr", lg: "1fr 1fr"}} gap={{base: "3rem", lg: "6rem"}}>
            ...
            <Box>
                ...
                <NextLink href={acf.introsektion.knap_link} passHref>
                    <Link variant={"blueBtn"} w="12rem" mt="3rem" justifyContent={"center"}>{acf.introsektion.knap_tekst}</Link>
                </NextLink>
            </Box>
        </Box>
    </Box>
