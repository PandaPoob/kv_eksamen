...
export default function BlivPlejefamilie({sideData, imgData}) {
  ...
  return (
    <PageLayout>
      ...
      <Box display={"grid"} placeContent="center" px="1rem" py={{ base: "3rem", lg: "6rem" }}>
        <Box maxW={"container.lg"} display="grid" gap="1rem">
          ...
          <Text textAlign={"center"} mb="2rem">
            Hvis du har lyst til at blive plejefamilie, så er du mere en velkommen til at kontakte det internat, som ligger nærmest dig til en uforpligtende snak.
          </Text>
          <NextLink href="/om-os/internater" passHref>
            <Link variant="redBtn" width={"12rem"} m="auto" justifyContent={"center"}>
              Se internaterne
            </Link>
          </NextLink>
        </Box>
