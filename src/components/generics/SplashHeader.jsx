...
function SplashHeader({acf, leftPos}) {
    ...
    return (
      <Box position="relative" height={"70vh"} width={"100vw"} overflow="hidden">
        ...
        <Box position="absolute" top={"0"} left={["0", "0", "0", leftPos, leftPos]} width={["100%", "100%", "100%", "50%", "50%"]} height={"100%"} bgColor="brand.darkGrey" opacity={"50%"}></Box>
