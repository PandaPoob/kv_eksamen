...
function SplashHeader({acf, h1mobsize="heading1", imgMobPos="center", imgWebPos = "center", textPos="left", height="70vh"}) {
        ...
        >
          ...
          {buttonChecker() && (
            <NextLink href={acf.buttonurl} passHref>
              <Link maxW={"10rem"} alignSelf={textPos} justifyContent="center" variant={"blueBtn"}>
                {acf.buttontekst}
              </Link>
            </NextLink>
          )}
